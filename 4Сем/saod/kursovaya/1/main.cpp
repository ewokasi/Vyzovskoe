...
int main() {
	...
	booking.add("1234-567890", "123G", "we", "sd");
	booking.add("3232232", "1223e", "df", "dfff");
	booking.add("3232232", "1223e", "df", "dfff");
	visitors.put("1234-567890", "Иванов_Иван_Иванович", 1980, "Москва, ул. Пушкина, д.1", "Отдых");
	visitors.put("2345-678901", "Петров_Петр_Петрович", 1990, "Санкт-Петербург, ул. Ломоносова, д.2", "Работа");
	visitors.put("3456-789012", "Сидоров_Сидор_Сидорович", 1975, "Казань, ул. Баумана, д.3", "Отдых");
